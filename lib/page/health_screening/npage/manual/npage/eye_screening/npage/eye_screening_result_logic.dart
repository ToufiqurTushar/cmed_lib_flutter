...
class EyeScreeningResultLogic extends BaseLogic {
  ...
  startDistanceVisionEyeScreening() {
    saveLocal();
    Get.offNamedUntil(EyeScreeningDistancevisionView.routeName, arguments: {'accessFrom' : accessFrom.value}, (route) => route.settings.name == EyeScreeningHomeView.routeName);
  }
