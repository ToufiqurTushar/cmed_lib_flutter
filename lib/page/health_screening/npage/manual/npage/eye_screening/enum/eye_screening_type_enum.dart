...
enum EyeScreeningTypeEnum {
  NEAR_VISION_BOTH_EYE(1,'N8', "label_near_vision_test", 'label_near_vision_test', 'N.B: If your near visual acuity is more than N8, you should consult with an eye doctor soon'),
  FAR_VISION_DISTANCE_1(2,'', "label_distance_vision_test", 'label_distance_vision_test', 'N.B: If your distance visual acuity is more than 6/9, you should consult with an eye doctor soon'),
  ILLITERATE_TEST(3,'', "Distance Vision's Illiterate Test", 'label_distance_vision_test', 'N.B: If your distance visual acuity is more than 6/9, you should consult with an eye doctor soon'),
  CHILDREN_EYE_TEST(4,'', "Distance Vision's Children Test", 'label_distance_vision_test','N.B: If your distance visual acuity is more than 6/9, you should consult with an eye doctor soon'),
  COLOR_BLIND_TEST(5,'', "label_color_blind_test", 'label_color_blind_test', 'Possible Red-green deficiency. Please contact with an eye care professional soon'),
  CONTRAST_TEST(6,'2.10 - 2.25', "label_color_contrast_test", 'label_color_contrast_test', 'Your Score is : 0 & you have contrast sensitivity impairment.');
