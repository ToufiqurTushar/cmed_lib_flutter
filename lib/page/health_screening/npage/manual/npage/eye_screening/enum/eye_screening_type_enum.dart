...
enum EyeScreeningTypeEnum {
  ...
  ILLITERATE_TEST(3,'', "Distance Vision's Illiterate Test", "নিরক্ষর দৃষ্টি পরীক্ষা", 'Distance Visual Acuity', 'নিরক্ষর দূরদৃষ্টি পরীক্ষার','N.B: If your distance visual acuity is more than 6/9, you should consult with an eye doctor soon', 'বি.দ্র.: আপনার দূরবর্তী দৃষ্টিসীমা যদি 6/9 থেকে বেশি হয় তাহলে অতিসত্বর একজন চক্ষু বিশেষজ্ঞের এর পরামর্শ নিন।'),
  CHILDREN_EYE_TEST(4,'', "Distance Vision's Children Test", "শিশুদের দৃষ্টি পরীক্ষা", 'Distance Visual Acuity', 'শিশুদের দূরদৃষ্টি পরীক্ষার','N.B: If your distance visual acuity is more than 6/9, you should consult with an eye doctor soon', 'বি.দ্র.: আপনার দূরবর্তী দৃষ্টিসীমা যদি 6/9 থেকে বেশি হয় তাহলে অতিসত্বর একজন চক্ষু বিশেষজ্ঞের এর পরামর্শ নিন।'),
