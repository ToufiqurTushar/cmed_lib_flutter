          ...
          if (value != null) {
            ...
            repository.sendData(AppUidConfig.getPostMeasurementUrl(), (measurementWfl).toJson()).then((value) {
              if (value != null) {
                ...
                //   Get.find<MeasurementSelectionDetailsLogic>().updateSelectedServiceTypeMeasurementStatus([measurementHfa, measurementWfa, measurementWfl]);
                // }
                updateSelectedCustomerHeightAndNavigate([measurementHfa, measurementWfa, measurementWfl]);
