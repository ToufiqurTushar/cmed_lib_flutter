...
class BloodGlucoseSelectTimePeriodView
    extends RapidView<BloodGlucoseSelectTimePeriodLogic> {
  static String routeName = '/blood_glucose_select_time_period_page';
  ...
  getTimePeriods() {
    if (int.parse((CustomDateUtils.getYearFromLong(controller.customer.value.birthDate).replaceAll("Y", ""))) > 18) {
      return [
