  ...
  Map<String, Map<String, String>> getI18n() {
      return {
        "en_US": {
          ...
          "High": "High",
          "HIGH blood sugar level, please consult with doctor for further evaluation.": "HIGH blood sugar level, please consult with doctor for further evaluation.",
          ...
          "Hyperglycemia (need confirmation)": "Hyperglycemia (need confirmation)",
        ...
        "bn_BD": {
          ...
          "High": "বেশি ঝুঁকি সম্পন্ন",
          "HIGH blood sugar level, please consult with doctor for further evaluation.": "রক্তে গ্লুকোজের মাত্রা বেশি, নিশ্চিত হওয়ার জন্য চিকিৎসকের পরামর্শ নিন।",
          "LOW (Hypoglycemia)": "বেশি ঝুঁকি সম্পন্ন",
          ...
          "Hyperglycemia (need confirmation)": "বেশি ঝুঁকি সম্পন্ন",
        ...
        "kn_IN": {
          ...
          "High": " ಹೆಚ್ಚು ",
          "HIGH blood sugar level, please consult with doctor for further evaluation.": "ಅಧಿಕ ರಕ್ತದ ಸಕ್ಕರೆ ಮಟ್ಟ, ಹೆಚ್ಚಿನ ಮೌಲ್ಯಮಾಪನಕ್ಕಾಗಿ ದಯವಿಟ್ಟು ವೈದ್ಯರನ್ನು ಸಂಪರ್ಕಿಸಿ.",
          "LOW (Hypoglycemia)": "ಲೊ (ಹೈಪರ್ ಗ್ಲೈಸಿಮಿಯಾ) ",
          ...
          "Hyperglycemia (need confirmation)": "ಹೈಪರ್ ಗ್ಲೈಸಿಮಿಯಾ (ಕನ್ ಫರ್ಮ್ ಆಗಬೇಕು)",
          ...
          "HIGH (Borderline)": "ಹೈ ಬಾರ್ಡರ್ ಲೈನ್",
