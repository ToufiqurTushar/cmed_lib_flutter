...
import 'bmi_height_weight_input_logic.dart';

class BmiHeightWeightInputView extends RapidView<BmiHeightWeightInputLogic> {
  static String routeName = '/bmi_height_weight_input_page';
                          ...
                          children: [
                            Expanded(
                              child: CMEDWhiteElevatedButton(
                                'label_enter'.tr,
                                () => {
                                  if (controller.isValidInput())controller.sendMeasurement(),
  ...
  void loadDependentLogics() {
    ...
    Get.put(BmiHeightWeightInputLogic(repository: Get.find<ScreeningReportRepository>(), profileRepository: Get.find<ProfileRepository>()));
  }
}
