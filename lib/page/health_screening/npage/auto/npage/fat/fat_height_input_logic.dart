...
class FatHeightInputLogic extends BaseLogic {
  ...
  String? validateHeightInCentimeter(String value) {
    ...
    if (GetUtils.isGreaterThan(
        ...
        GetUtils.isLowerThan(
            double.parse(value), MeasurementConstant.HEIGHT_CENTIMETER_MIN)) {
      return 'error_message_invalid_range'.tr;
    }
    return null;
  }
  ...
  String? validateHeightInInch(String value) {
    ...
    if(getHeightInCentimeter() < MeasurementConstant.HEIGHT_CENTIMETER_MIN || getHeightInCentimeter() > MeasurementConstant.HEIGHT_CENTIMETER_MAX) {
      return 'error_message_invalid_range'.tr;
    }
    return null;
  }
