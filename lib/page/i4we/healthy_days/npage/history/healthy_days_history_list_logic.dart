...
class HealthyDaysListLogic extends BaseLogic {
  ...
  void onInit() {
    super.onInit();
    if(Get.arguments is HealthyDaysArgument) {
      final arg = Get.arguments as HealthyDaysArgument;
      if (arg.date != null) {
  ...
  getData() async {
    ...
    httpProvider.GET(ApiUrl.getHealthyDaysSurveyUrl(customer.value.userId!, fromDate: fromDate, toDate: toDate)).then((response){
