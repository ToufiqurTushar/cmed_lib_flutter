...
import 'family_profile_survey_history_list_logic.dart';


class FamilyProfileSurveyHistoryListView extends RapidView<FamilyProfileSurveyListLogic> {
  static const routeName = '/FamilyProfileSurveyHistoryListView';
  final bool showAppTitle;
  FamilyProfileSurveyHistoryListView({super.key, this.showAppTitle = true});
  ...
  void loadDependentLogics() {
    Get.lazyPut<FamilyProfileSurveyListLogic>(() => FamilyProfileSurveyListLogic(),);
  }
}
