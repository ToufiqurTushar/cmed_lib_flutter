...
import 'family_profile_survey_i18n.dart';
import 'family_profile_survey_logic.dart';


class FamilyProfileSurveyView extends RapidView<FamilyProfileSurveyLogic> {
  static String routeName = "/FamilyProfileSurveyView";

  const FamilyProfileSurveyView({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          //     //   onTap: (){
          //     //     Get.toNamed(FamilyProfileSurveyHistoryListView.routeName, arguments: controller.customer);
          //     //   },
  ...
  void loadDependentLogics() {
    Get.put(FamilyProfileSurveyLogic());
  }
  ...
  Map<String, Map<String, String>> getI18n() {
    return FamilyProfileSurveyI18N.getTranslations();
  }
}
