...
import 'wellness_response_result_logic.dart';

class WellnessResponseResultView extends RapidView<WellnessResponseResultLogic> {
  static String routeName = '/WellnessResponseResultView';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BasicAppBar('Wellness Response'.tr),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
  ...
  void loadDependentLogics() {
    Get.put(WellnessResponseResultLogic());
  }
}
