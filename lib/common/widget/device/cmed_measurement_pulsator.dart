...
class CMEDMeasurementPulsator extends StatefulWidget {
  final String title;
  IconData? iconData;
  Color? iconColor;

  CMEDMeasurementPulsator(this.title, this.iconData,
      {super.key, this.iconColor});

  @override
  State<CMEDMeasurementPulsator> createState() => _AnimatedContainerAppState();
}

class _AnimatedContainerAppState extends State<CMEDMeasurementPulsator> {
