...
Card SurveyResultItemWidget({required BuildContext context, Color? color, required String title, required String image, String? defaultImage, String? subtitle, bool isColoredTitle = false, required String date, required GestureTapCallback onTap}) {
  return Card(
    color: Colors.white,
    child: ListTile(
