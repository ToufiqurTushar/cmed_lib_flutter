...
Card SurveyResultItemWidget({required BuildContext context, Color? color, bool? defaultIconBackroundColor, required String title, required String image, String? defaultImage, required String subtitle, required String date, required GestureTapCallback onTap}) {
  return Card(
    color: Colors.white,
    child: ListTile(
      leading: CircleAvatar(
        radius: 22,
        backgroundColor: (defaultIconBackroundColor??false)? null: color??Colors.red,
