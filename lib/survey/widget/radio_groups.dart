            ...
            Theme(
              ...
              child: FormBuilderRadioGroup<dynamic>(
                ...
                options: field.options!.map((FieldOption option) => FormBuilderFieldOption(
                  value: option.value,
                  child: Container(padding: const EdgeInsets.symmetric(vertical: 4),width:(field.options?.length??0) <= 3? Get.width*.3: null, child: Align(alignment: Alignment.centerLeft, child: Text(option.title!, textAlign: TextAlign.left,)),),
